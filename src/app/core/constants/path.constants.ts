export const PathConstants = {
  ...
  MANAGE_TRIAGE_PATH: 'manage-triage',
  TRIAGE_DETAILS_PATH: 'triage/:id',
  PATIENT_TRIAGE_PATH: 'patient-triage/:patientId',
  NURSE_TRIAGE_PATH: 'nurse-triage/:nurseId',
  MANAGE_MEDICAL_RECORD_PATH: 'manage-medical-record',
  PERSONAL_MEDICAL_RECORD_PATH: 'personal-medical-record',
};
