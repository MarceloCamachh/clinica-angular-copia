...
export class NavComponent {
  navItems: NavItem[] = [
    ...
    {
      listItemText: 'Historial Médico Personal',
      listItemPath: PathConstants.PERSONAL_MEDICAL_RECORD_PATH,
      requireLogin: true,
    ...
    {
      listItemText: 'Gestionar Triage',
      listItemPath: PathConstants.MANAGE_TRIAGE_PATH,
      requireLogin: true,
      allowedRoles: [UserRole.ADMIN, UserRole.DOCTOR],
    },/* 
    {
      listItemText: 'Historial Médico',
      listItemPath: PathConstants.MANAGE_MEDICAL_RECORD_PATH,
      requireLogin: true,
      allowedRoles: [UserRole.ADMIN, UserRole.DOCTOR],
    }, */
  ];
